    ...
    <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      ...
      <div className="rounded-xl relative">
        ...
        <div className="absolute w-full h-full bg-black/50 text-white rounded-xl">
          ...
          <p className="px-2">Througt 8/26</p>
          <button className="border-white font-semibold bg-tranparent text-white mx-2 absolute bottom-4 hover:bg-slate-50 hover:text-black hover:border-white transition-all">
            Order Now
          </button>
        </div>
        <img
